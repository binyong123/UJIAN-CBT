...
$config['versi']                = "VERSI 3.0";           //isi sesuai kebutuhan nama pada header
$config['tgl']                  = "Nama Kota, 27 Mei 2021";
$config['tampil_nilai']         = FALSE;            // jika siswa boleh melihat hasil ujian, isikan TRUE, jika tidak FALSE, default TRUE
$config['nama_sekolah']         = "Nama Sekolah"; //isi sesuai kebutuhan nama sekolah
$config['nama_ujian']           = "PAT GENAP - 2020/2021"; //isi sesuai kebutuhan jenis ujian
$config['nama_kepala']          = "Nama Kepala Sekolah"; //isi sesuai nama kepala
$config['nip_kepala']           = "NIP Kepala Sekolah"; //isi sesuai nama kepala
